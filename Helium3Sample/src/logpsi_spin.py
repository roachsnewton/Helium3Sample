...
def make_logpsi(flow, sp_indices, L):
    ...
    def logpsi(x, params, state_idx):
        ...
        log_phi_dn = logslaterdet(sp_indices[state_idx[nup:]], z[nup:], L)
        log_phi = log_phi_up + log_phi_dn
...
def make_quantum_force(logpsi):
    ...
    @partial(jax.vmap, in_axes=(0, None, 0), out_axes=0)
    def quantum_force(x, params, state_idx):
        logpsi2 = lambda x, params, state_idx: 2 * logpsi(x, params, state_idx)[0]
        return jax.grad(logpsi2)(x, params, state_idx)
