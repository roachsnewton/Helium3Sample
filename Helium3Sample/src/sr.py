...
def fisher_sr(score_fn, damping, maxnorm):
    """
    ...
    def update_fn(grads, state, params):
        ...
        scale = jnp.minimum(jnp.sqrt(maxnorm/gnorm), 1)
...
def hybrid_fisher_sr(classical_score_fn, quantum_score_fn, 
                     lr_c, lr_q, decay,
                     damping_c, damping_q, 
                     maxnorm_c, maxnorm_q):
    """
    ...
    Params:
        ...
        steps, (total number of steps: i)
        damping_c, damping_q, (damping for classical and quantum model)
        max_norm_c, max_norm_q, (max norm for classical and quantum model)
    """
